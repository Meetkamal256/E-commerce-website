...
if (isset($_POST['insert_product'])) {
    ...
    $insert_query = "INSERT INTO products (product_title, product_price, product_image1, product_image2, product_image3, product_description, category_id) 
    VALUES ('$product_title', '$price', '$product_image1','$product_image2', '$product_image3', '$description', '$product_category')";
